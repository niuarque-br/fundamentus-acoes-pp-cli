...
but do not stop the import.`,
  ...
  fundamentus-acoes-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  fundamentus-acoes-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | fundamentus-acoes-pp-cli import <resource> --input -`,
