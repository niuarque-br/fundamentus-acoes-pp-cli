...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "fundamentus-acoes-pp-cli",
		Short: "Manage fundamentus-acoes resources via the fundamentus-acoes API",
		Long: `Manage fundamentus-acoes resources via the fundamentus-acoes API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'fundamentus-acoes-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("fundamentus-acoes-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'fundamentus-acoes-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCrawlDetalhesAcaoPromotedCmd(flags))
